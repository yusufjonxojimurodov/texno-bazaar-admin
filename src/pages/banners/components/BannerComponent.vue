...
<template>
    <div class="!flex justify-start items-center gap-3 flex-wrap">
        <a-card v-for="banner in bannerStore.banners" :key="banner.id"
            ...
            <div class="flex justify-center items-start flex-col gap-3 mt-2">
                ...
                <div class="flex justify-between items-center w-full">
                    ...
                    <div class="flex justify-end items-end gap-2">
                        <a-button :loading="loadingMap[banner.id]" @click="changeStatus(banner.id, banner.status)"
                        ...
                        <a-popconfirm @confirm="deleteBanner(banner.id)" title="O'chirishga rozimisiz ?">
